...
import { adminApi, type AdminUser, type AdminUserDetails } from "../features/admin/api";
...
export function AdminPage() {
  ...
  const data = tab === "users" ? users.data : projects.data; const loading = tab === "users" ? users.isLoading : projects.isLoading; const error = tab === "users" ? users.error : projects.error;
