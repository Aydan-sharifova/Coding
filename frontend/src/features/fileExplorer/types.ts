...
export interface FileContent { nodeId: string; path: string; content: string; contentHash: string; concurrencyToken: string; versionNumber: number; updatedAt: string; }
...
export interface FileVersionDetails extends FileVersion { content: string; }
